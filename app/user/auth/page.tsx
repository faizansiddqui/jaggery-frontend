        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              onClick={onSendOtp}
              disabled={loading}
              className="border-2 border-[#1c1b1b] cursor-pointer px-6 py-3 font-headline text-[11px] uppercase tracking-widest hover:bg-[#1c1b1b] hover:text-white transition-colors disabled:opacity-40"
            >
            ...
            {otpSent && (
              <button
                ...
                onClick={onVerifyOtp}
                disabled={loading}
                className="bg-[#1c1b1b] text-white px-6 py-3 cursor-pointer font-headline text-[11px] uppercase tracking-widest hover:bg-[#b90c1b] transition-colors disabled:opacity-40"
              >
                Verify & Continue
              </button>
            )}
