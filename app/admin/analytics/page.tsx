...
export default function AdminAnalytics() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto p-4 md:p-8 space-y-8 text-slate-100">
      {/* Header */}
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-200 dark:border-slate-800">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase">System Intelligence</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 dark:text-white uppercase italic">
            Kinetic<span className="text-primary">.</span>Insight
          </h2>
        </div>
            ...
            {(data?.regional || [{ region: 'Global', growthPercent: 0 }]).map((r, i) => (
              <div key={i} className="group">
                <div className="flex justify-between items-end mb-2">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-widest group-hover:text-primary transition-colors">{r.region}</span>
