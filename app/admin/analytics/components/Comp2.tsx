      ...
      <header className="flex justify-between items-center w-full px-8 h-16 sticky top-0 z-50 bg-[#fcf8f8] dark:bg-[#1c1b1b] border-b-0 tonal-shift">
        <div className="flex items-center gap-8 flex-1">
          ...
          <div className="relative w-96">
            ...
            <input
              className="w-full bg-surface-container-low border-none focus:ring-0 text-sm py-2 pl-10 placeholder:opacity-40 uppercase tracking-widest font-['Space_Grotesk']"
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="text-sm font-bold text-[#b90c1b] font-['Space_Grotesk'] uppercase tracking-wider hover:opacity-80 active:scale-95 transition-all">
            Profile
          </button>
        </div>
      </header>
