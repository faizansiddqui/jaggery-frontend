    ...
    <>
      <main className="ml-64 pt-24 px-10 pb-12 min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-12 lg:col-span-8 space-y-10">
            <section className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 bg-surface-container-lowest p-10 border border-outline-variant/10">
              <div className="flex items-center gap-8">
                <div className="relative">
                  ...
                  />
                  <div className="absolute -bottom-2 -right-2 bg-primary text-white px-3 py-1 text-[10px] font-black uppercase tracking-tighter">
                    VIP TIER 3
                  </div>
                </div>
                <div>
                  <h2 className="font-impact text-6xl tracking-tight leading-none uppercase mb-1">
                    Elena Vance
                  </h2>
                  ...
                  <div className="mt-4 flex gap-2">
                    <span className="bg-surface-container-high px-4 py-1 text-[10px] font-bold uppercase tracking-widest">
                      Early Adopter
                    </span>
                    <span className="bg-surface-container-high px-4 py-1 text-[10px] font-bold uppercase tracking-widest">
                      Hype Curator
              ...
              <div className="text-right">
                <p className="text-[10px] font-bold opacity-40 uppercase tracking-[0.2em] mb-1">
                  Lifetime Spend
                </p>
            ...
            <div className="mt-12 border-b border-outline-variant/20 flex gap-10">
              <button className="pb-4 border-b-2 border-primary text-primary text-xs font-bold uppercase tracking-[0.1em]">
                Order History
              </button>
              <button className="pb-4 text-xs font-bold uppercase tracking-[0.1em] opacity-40 hover:opacity-100 transition-opacity">
                Wishlist Items (12)
              </button>
              <button className="pb-4 text-xs font-bold uppercase tracking-[0.1em] opacity-40 hover:opacity-100 transition-opacity">
                Support Tickets (1)
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="text-[10px] font-bold uppercase tracking-widest opacity-40 border-b border-outline-variant/10">
                ...
                <tbody className="text-sm font-headline">
                  <tr className="border-b border-outline-variant/10 hover:bg-white transition-colors group">
                    ...
                    <td className="py-6 px-2 opacity-60 uppercase">
                      Oct 12, 2023
                    </td>
                    <td className="py-6 px-2">
                      <span className="bg-primary/10 text-primary px-3 py-1 text-[9px] font-black uppercase tracking-widest">
                        Shipped
                      </span>
                    </td>
                  ...
                  <tr className="border-b border-outline-variant/10 hover:bg-white transition-colors group">
                    ...
                    <td className="py-6 px-2">
                      <span className="bg-black/10 text-black px-3 py-1 text-[9px] font-black uppercase tracking-widest">
                        Delivered
                      </span>
                    </td>
            ...
            <div className="mt-6 flex justify-center">
              <button className="border border-outline-variant/40 px-8 py-3 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-surface-container-high transition-colors">
                Load Full History
              </button>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-8">
            <div className="bg-on-surface text-white p-8 space-y-6">
              <h3 className="font-impact text-3xl uppercase tracking-wider">
                Quick Actions
              </h3>
            ...
            <div className="bg-surface-container-low p-8 space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-[9px] font-bold opacity-40 uppercase tracking-widest mb-2">
                    Preferred Categories
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-surface-container-highest px-3 py-1 text-[10px] font-bold uppercase">
                      Outerwear
                    </span>
                    <span className="bg-surface-container-highest px-3 py-1 text-[10px] font-bold uppercase">
                      Footwear
            ...
            <div className="border border-outline-variant/30 p-8">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/50 space-y-2">
                  ...
                  <div className="flex justify-between items-center opacity-40 text-[9px] font-bold uppercase tracking-widest">
        ...
        <div className="mt-20 overflow-hidden bg-primary py-4 -mx-10 whitespace-nowrap">
          <div className="inline-block animate-marquee font-impact text-4xl text-white uppercase tracking-[0.1em] opacity-30">
