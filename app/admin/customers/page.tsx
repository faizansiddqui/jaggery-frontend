        ...
        <div className="flex flex-col gap-8 max-w-[1600px] mx-auto w-full animate-in fade-in duration-500">
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex flex-col gap-1.5">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Customer Analytics</h2>
                </div>
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="relative w-full md:w-80">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#b90c1b]/20 focus:border-[#b90c1b] transition-all shadow-sm"
                        />
                    </div>
                    <button 
