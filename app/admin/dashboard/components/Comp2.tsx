    ...
    <>
      <header className="flex justify-between items-center w-full px-8 h-16 sticky top-0 z-50 bg-[#fcf8f8] dark:bg-[#1c1b1b] border-b-0 tonal-shift bg-[#f6f3f2] dark:bg-[#252424] flat no shadows">
        ...
        <div className="flex items-center gap-6">
          <button className="relative text-[#1c1b1b] dark:text-[#fcf8f8] opacity-70 hover:bg-[#ebe7e7] dark:hover:bg-[#333131] transition-colors duration-200 p-2">
            <span className="material-symbols-outlined">notifications</span>
            <span className="absolute top-1 right-1 w-2 h-2 bg-primary rounded-full"></span>
          </button>
          <button className="text-[#1c1b1b] dark:text-[#fcf8f8] opacity-70 hover:bg-[#ebe7e7] dark:hover:bg-[#333131] transition-colors duration-200 p-2">
            <span className="material-symbols-outlined">mail</span>
          </button>
          <div className="h-8 w-[1px] bg-outline-variant/30"></div>
          <button className="text-[#b90c1b] font-bold border-b-2 border-[#b90c1b] py-1 font-['Space_Grotesk'] uppercase tracking-wider text-xs">
            Profile
          </button>
        </div>
      </header>
