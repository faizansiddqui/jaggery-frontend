      ...
      <header className="flex justify-between items-center w-full px-8 h-16 sticky top-0 z-50 bg-[#fcf8f8] dark:bg-[#1c1b1b] border-b-0 tonal-shift bg-[#f6f3f2] dark:bg-[#252424] flat no shadows">
        <div className="flex items-center gap-8">
          ...
          <div className="relative group">
            ...
            <input
              className="bg-transparent border-none focus:ring-0 text-xs tracking-widest font-['Space_Grotesk'] w-64 pl-10 uppercase"
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="text-[#b90c1b] font-bold border-b-2 border-[#b90c1b] py-1 font-['Space_Grotesk'] uppercase tracking-wider text-xs active:opacity-80 active:scale-95">
            Profile
          </button>
        </div>
      </header>
