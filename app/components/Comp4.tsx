    ...
    <>
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-[1920px] mx-auto">
        <div className="flex justify-between items-end mb-8 md:mb-12">
          <h2 className="font-brand text-4xl sm:text-6xl md:text-8xl text-on-surface leading-none uppercase">
            Categories
          </h2>
          <div className="h-1 bg-primary w-16 md:w-24 mb-2 md:mb-4"></div>
        </div>
