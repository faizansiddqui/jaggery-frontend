export default function Section8() {
  return (
    <>
      <section className="py-24 px-8 max-w-[1920px] mx-auto overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          <div className="lg:col-span-7 relative h-[600px] bg-on-surface overflow-hidden">
            <img
            ...
            <div className="absolute inset-0 p-12 flex flex-col justify-end">
              <h2 className="font-brand text-8xl text-surface leading-none mb-6">
                LIMITLESS
                <br />
                EVOLUTION
              </h2>
              <p className="text-surface font-body max-w-md text-lg mb-8 uppercase tracking-widest leading-tight">
                A numbered collection of 100 units. Precision engineered for the
                urban athlete. No restocks.
              </p>
              <button className="w-fit bg-primary text-surface px-12 py-5 font-headline font-bold uppercase tracking-widest hover:bg-surface hover:text-on-surface transition-all">
                Secure Access
              </button>
            </div>
          </div>
