        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-stretch">
          <div className="lg:col-span-7 relative min-h-[400px] md:h-[600px] bg-on-surface overflow-hidden">
            ...
            <div className="absolute inset-0 p-6 md:p-12 flex flex-col justify-end">
              ...
              <Link href="/shop/sale" className="w-fit bg-primary cursor-pointer text-surface px-8 md:px-12 py-4 md:py-5 font-headline font-bold uppercase tracking-widest hover:bg-surface hover:text-on-surface transition-all active:scale-95">
                Secure Access
              </Link>
            </div>
          </div>
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="bg-surface-container-high p-8 md:p-12 flex-1 flex flex-col justify-between">
              <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/shop/jackets" className="material-symbols-outlined cursor-pointer text-4xl text-primary">
                  arrow_forward
                </Link>
              </div>
            </div>
            <div className="h-64 relative overflow-hidden group">
              <img
                ...
                alt="Model running in reflective streetwear"
