export default function Comp9() {
  return (
    <>
      <section className="py-16 md:py-24 bg-surface px-4 md:px-8 overflow-hidden">
        <div className="max-w-[1920px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
            <div className="relative">
              <div className="absolute -top-6 md:-top-12 -left-6 md:-left-12 font-brand text-[8rem] sm:text-[12rem] md:text-[20rem] text-on-surface/5 select-none leading-none">
                RIOT
              </div>
              <blockquote className="relative z-10">
                <span className="text-primary text-4xl md:text-6xl font-brand">"</span>
                <p className="font-headline text-2xl sm:text-3xl md:text-5xl font-black uppercase tracking-tight text-on-surface mb-8 md:mb-12 leading-tight">
                ...
                <cite className="not-italic block">
                  <span className="font-headline font-bold text-lg md:text-xl uppercase text-primary tracking-widest">
                    — MARCUS CHENG
                  </span>
                  <span className="block font-body text-xs md:text-sm text-zinc-500 uppercase tracking-widest mt-1">
