    ...
    <footer className="bg-[#fcf8f8] text-[#1c1b1b] border-t border-[#1c1b1b]/10 py-24 px-8 lg:px-24">
      <div className="max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4 mt-4">
             <Link href={process.env.NEXT_PUBLIC_INSTAGRAM_URL || "#"} target="_blank" className="w-11 h-11 border border-[#1c1b1b]/10 flex items-center justify-center hover:bg-[#b90c1b] transition-all hover:border-[#b90c1b] group">
             ...
             <Link href={process.env.NEXT_PUBLIC_TWITTER_URL || "#"} target="_blank" className="w-11 h-11 border border-[#1c1b1b]/10 flex items-center justify-center hover:bg-[#b90c1b] transition-all hover:border-[#b90c1b] group">
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform fill-current group-hover:text-white" viewBox="0 0 24 24">
                  <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                </svg>
             </Link>
             <Link href={process.env.NEXT_PUBLIC_FACEBOOK_URL || "#"} target="_blank" className="w-11 h-11 border border-[#1c1b1b]/10 flex items-center justify-center hover:bg-[#b90c1b] transition-all hover:border-[#b90c1b] group">
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform fill-current group-hover:text-white" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4 font-headline text-sm text-[#1c1b1b]/60 uppercase tracking-widest">
            ...
            <li><Link href="/shop" className="hover:text-[#b90c1b] transition-colors">TECHNICAL GEAR</Link></li>
            <li><Link href="/shop" className="hover:text-[#b90c1b] transition-colors">EDITORIAL DROPS</Link></li>
            <li><Link href="/shop" className="hover:text-[#b90c1b] transition-colors">ACCESSORIES</Link></li>
            <li><Link href="/shop" className="hover:text-[#b90c1b] transition-colors">LIMITED ARCHIVES</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-[1920px] mx-auto pt-12 flex flex-col md:flex-row justify-between items-center gap-8 font-headline text-[10px] tracking-[0.3em] text-[#1c1b1b]/40 uppercase">
        <div className="flex gap-8">
           <span>© 2024 {(process.env.NEXT_PUBLIC_SITE_NAME || 'STREETRIOT').toUpperCase()} INDUSTRIES</span>
