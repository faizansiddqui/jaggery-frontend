      ...
      <section className="py-16 md:py-24 bg-surface-container-low px-4 md:px-8">
        <div className="max-w-[1920px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-6 md:gap-8">
            ...
            <button className="border-b-2 border-on-surface font-headline font-bold text-xs md:text-sm tracking-widest pb-1 hover:text-primary hover:border-primary transition-all">
              VIEW ALL PRODUCTS
            </button>
          </div>
