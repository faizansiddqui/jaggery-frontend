    ...
    <>
      <main className="pt-24 pb-20">
        <header className="px-8 mb-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-outline-variant/20 pb-4">
            <div>
              <h1 className="font-brand text-7xl md:text-9xl leading-[0.8] uppercase tracking-tighter">
                The Riot Journal
              </h1>
              <p className="font-headline uppercase tracking-widest text-xs mt-4 opacity-70">
        ...
        <section className="overflow-hidden py-4 bg-on-surface text-surface mb-12">
          <div className="flex whitespace-nowrap gap-12 items-center">
            <div className="flex gap-12 animate-none font-brand text-4xl uppercase tracking-widest">
